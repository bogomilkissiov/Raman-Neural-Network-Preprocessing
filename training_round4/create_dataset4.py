...
# Configure paths so imports and outputs resolve whether running from project root or inside training_round4
...
num_workers = 4
base_dir = os.path.join(SCRIPT_DIR, "training_data4")
...
def main():
    ...
    print("=" * 70)
    print("DATASET GENERATION PIPELINE (ROUND 4)")
    print("=" * 70)
