...
# -----------------------------------------------------------------------------
# Look for test_spectra within the local training_round1 folder or relative to project root
test_spectra_dir = os.path.join(SCRIPT_DIR, "test_spectra")
if not os.path.exists(test_spectra_dir):
    test_spectra_dir = "test_spectra"
...
model_weights_path = os.path.join(SCRIPT_DIR, "dual_supervised_resnet1.pth")
